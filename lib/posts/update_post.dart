                    ...
                    if (widget.post != null)
                      GestureDetector(
                        onTap: () async {
                          ...
                          await viewModel.deletePost(context, widget.post!.id ?? "");
                          viewModel.resetPost();
                          // Navigate back to home page and refresh data
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(builder: (context) => Feeds()), // Replace with your home screen widget
                          );
                        },
                        child: Text(
                          'Delete'.toUpperCase(),
